...
(function($) {
        ...
        jQuery(livereLib).bind('livereEvent', function(event, param) {
            ...
            switch (key) {
                ...
                case "getArticleHandlerComplete":
                    break;
                case "getArticleComplete":$.fn.fullpage.reBuild();
                    break;
	...
	$(document).ready(function() {
		...
		$('#storeTesterForm', $(document)).on('click', '.report #checkMyStore', function(e) {
			...
			var searchUrl = "http://www.banilaco.com/m/customer/customerStore.do?area_code="+locationId+"&searchText="+encodeURIComponent(storeName);
			$.view.popup(searchUrl, "viewMyStore", 1024, 768);	
		});
